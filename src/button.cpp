...
Button::Button(Scene *scene, std::shared_ptr<Material> material, bool disable_on_trigger, std::function<void()> trigger_callback,
...
std::shared_ptr<SceneNode> Button::getSceneNode() { return m_root_node; }
