...
std::shared_ptr<Model> ResourceManager::cube(std::shared_ptr<Material> material) {
  return cube(material, DEFAULT_MODEL_COLOR);
}
...
std::shared_ptr<Model> ResourceManager::sphere(std::shared_ptr<Material> material) {
  return sphere(material, DEFAULT_MODEL_COLOR);
}
