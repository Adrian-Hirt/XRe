...
SceneManager::SceneManager(std::shared_ptr<VulkanHandler> vulkan_handler) { m_vulkan_handler = vulkan_handler; }

void SceneManager::registerScene(std::string name, SceneFactory factory) { m_scene_factories[std::move(name)] = std::move(factory); }
